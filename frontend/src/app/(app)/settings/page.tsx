      ...
      <div className="w-full max-w-3xl bg-white dark:bg-slate-800 rounded-[2rem] shadow-sm p-6 sm:p-10 border border-gray-100 dark:border-slate-700 flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 dark:text-slate-400 text-xs mt-0.5">marchydluffy@gmail.com</p>
                </div>
              </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 pl-2 sm:pl-8">
            ...
            <Link
              href="/terms"
              className="flex items-center justify-between p-4 rounded-2xl border border-gray-100 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm hover:shadow-md hover:bg-gray-50/50 dark:hover:bg-slate-700/50 transition-all cursor-pointer group"
            >
              <div className="flex items-center gap-3">
